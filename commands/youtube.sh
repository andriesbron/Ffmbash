...
COMMAND="-i \"${ff_vdev}:${ff_adev}\" -deinterlace -vcodec libx264 -pix_fmt yuv420p -preset $QUAL ${ffmbashfpsin} -g $(($FPS * 2)) -b:v $VBR -acodec libmp3lame -ar 44100 -threads 6 -qscale 3 -b:a 712000 -bufsize 512k -f flv '$YOUTUBE_URL/$YOUTUBE_KEY'"
